...
LOG_PATH    = "77_EventLogReport.txt"  # 入力ログ
BIN_SECONDS = 3600
TOTAL_HOURS = 12
EXCLUDE_BOX = True
EXCLUDE_DO = True
OUT_DIR     = "77_result" # 出力フォルダ
...
high_csv_path = os.path.join(OUT_DIR, "MH_hourly_firsttime_77.csv")
...
# 全体サマリ
low_summary_path = os.path.join(OUT_DIR, "ML_arrival_rate_77.csv")
...
low_byid_path = os.path.join(OUT_DIR, "ML_arrival_rate_by_id_77.csv")
